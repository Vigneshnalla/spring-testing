...
import com.vignesh.bookstore.orders.domain.models.OrderStatus;
...
interface OrderRepository extends JpaRepository<OrderEntity, Long> {
    ...
    default void updateOrderStatus(String orderNumber, OrderStatus orderStatus) {
        Optional<OrderEntity> orderEntity = this.findByOrderNumber(orderNumber);
    ...
    @Query(
            """
                    select new com.vignesh.bookstore.orders.domain.models.OrderSummary(o.orderNumber, o.status)
                    from OrderEntity o
