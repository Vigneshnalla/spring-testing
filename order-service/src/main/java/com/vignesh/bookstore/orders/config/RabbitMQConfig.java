...
class RabbitMQConfig {
    ...
    DirectExchange exchange() {
        return new DirectExchange(properties.getOrderEventsExchange());
    }
    ...
    Binding newOrdersQueueBinding() {
        return BindingBuilder.bind(newOrdersQueue()).to(exchange()).with(properties.getNewOrdersQueue());
    }
    ...
    Binding deliveredOrdersQueueBinding() {
        return BindingBuilder.bind(deliveredOrdersQueue()).to(exchange()).with(properties.getDeliveredOrdersQueue());
    }
    ...
    Binding cancelledOrdersQueueBinding() {
        return BindingBuilder.bind(cancelledOrdersQueue()).to(exchange()).with(properties.getCancelledOrdersQueue());
    }
    ...
    Binding errorOrdersQueueBinding() {
        return BindingBuilder.bind(errorOrdersQueue()).to(exchange()).with(properties.getErrorOrdersQueue());
    }
    ...
    public String catalogServiceUrl() {
        return properties.getCatalogServiceUrl();
    }
}
